...
export const modelsTypes: IPropositionsTypeViewModel[] = [
	{
		name: 'Comunicados',
...
export const insertItem = async (knex: Knex, items: IPropositionsTypeViewModel[], parentId?: number): Promise<void> => {
...
export const delItem = async (knex: Knex, items: IPropositionsTypeViewModel[]): Promise<void> => {
	return items.forEach(async i => {
